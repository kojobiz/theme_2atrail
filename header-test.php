                ...
                <main>
                    <div class="page-contents" style="padding-top: 0px;">
                        <div class="page-head" style="max-height: 230px;">
                            ...
                            <div class="wrapper">
                                <span class="page-title" style="font-weight: 200; font-size: 2.2rem; margin-top: 0px!important;"><?php echo get_main_title(); ?></span>
                                <h2 class="page-title-en" style="font-size: 1.5rem; font-style: italic;"><?php echo get_main_en_title(); ?></h2>
                            </div>
                        </div>
