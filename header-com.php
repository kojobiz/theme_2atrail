            ...
            <div id="primary" class="content-area">
                <main>
                    <div class="page-contents" style="padding-top: 0px;">
                        <div class="page-head" style="max-height: 230px;">
                            <img src="https://atrail.co.jp/wp-content/uploads/images/bg-section-company.webp" alt="" style="max-height: 230px; object-position: center 42%;">
                            <div class="wrapper" style="height: 20%; position: absolute; bottom: 0; width: 20vw; border-radius: 0px 10px 0px 0px; color: #fff; background-color: rgb(25 83 56 / 78%); text-align: left; padding-left: 2%; bottom: 0!important; left:0!important; transform: translate(0%, 150%); padding-top: 6px; padding-bottom: 3px;">
